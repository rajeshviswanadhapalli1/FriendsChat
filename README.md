...
- **Authentication**: Mobile number-based OTP authentication
...
- **Voice/Video Calls**: Agora RTC + Socket.io signaling (see [CALLING_SOCKET_GUIDE.md](CALLING_SOCKET_GUIDE.md))
...
# Optional: Agora (for voice/video calls)
AGORA_APP_ID=your_agora_app_id
AGORA_APP_CERTIFICATE=your_agora_app_certificate
# Optional: temp token for dev (no token auth in console)
AGORA_TEMP_TOKEN=your_agora_temp_token
